...
class DatabaseInitializer:
    ...
    def _create_vendor_staging_table(self) -> bool:
        ...
        CREATE TABLE IF NOT EXISTS vendor_staging_data (
            ...
            Vendor_ID VARCHAR(255) DEFAULT '',
            Quantity VARCHAR(255) DEFAULT '',
            Stems_Bunch VARCHAR(255) DEFAULT '',
            Unit_Type VARCHAR(255) DEFAULT '',
            Staging_ID VARCHAR(255) DEFAULT '',
            Object_Mapping_ID VARCHAR(255) DEFAULT '',
            Company_ID VARCHAR(255) DEFAULT '',
            User_ID VARCHAR(255) DEFAULT '',
            Product_Mapping_ID VARCHAR(255) DEFAULT '',
            Email VARCHAR(255) DEFAULT '',
            client_id VARCHAR(100) NOT NULL,
            batch_id VARCHAR(100) DEFAULT '',
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
